...
export default function DistributorDashboard() {
  ...
  useEffect(() => {
    ...
    if (!isLoading && user && user.role !== 'distributor') {
      toast({
        title: "Access Denied", 
        description: "This dashboard is only for distributors.",
        variant: "destructive",
      });
      setTimeout(() => {
        window.location.href = "/";
    ...
    return (
      <div className="min-h-screen auromart-gradient-bg flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Loading distributor dashboard...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">Distributor Dashboard</p>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {productsLoading ? "..." : manufacturerProducts?.length || 0}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    ${statsLoading ? "..." : stats?.monthlySales || 0}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent>
                {ordersLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">No orders from retailers yet</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {retailerOrders?.slice(0, 5).map((order: any) => (
              ...
              <CardContent>
                {retailersLoading ? (
                  ...
                  <div className="text-center py-4">
                    ...
                    <p className="text-sm text-gray-500">No retailers connected</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {retailers?.slice(0, 3).map((retailer: any) => (
                      <div key={retailer.id} className="flex items-center space-x-3 p-3 border rounded-lg">
                        <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                          <span className="text-sm font-medium text-green-600">
                            {retailer.businessName?.charAt(0) || retailer.firstName?.charAt(0)}
                          </span>
                        </div>
                        <div className="flex-1">
                          <p className="text-sm font-medium">{retailer.businessName}</p>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-semibold text-blue-600">3.2h</span>
                  </div>
                  <div className="flex items-center justify-between">
